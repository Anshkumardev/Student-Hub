...
public class FashionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backImage = findViewById(R.id.backImageFashionClub);
        ...
        image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),ClubsImageViewActivity.class);
                intent.putExtra("IMAGE",R.drawable.f2);
                startActivity(intent);
            }
        });
        ...
        image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),ClubsImageViewActivity.class);
                intent.putExtra("IMAGE",R.drawable.f3);
                startActivity(intent);
            }
        });
    ...
    public void openWhatsApp(View view){
        try {
            ...
            String toNumber = "919870603898"; // Replace with mobile phone number without +Sign or leading zeros, but with country code
    ...
    public void openInsta(View view){
        Uri uri = Uri.parse("https://instagram.com/saoirse_gbu?igshid=183skdfvnwbfj");
        ...
        try {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("https://instagram.com/saoirse_gbu?igshid=183skdfvnwbfj")));
        }
    }
}