...
public class YogaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backImage = findViewById(R.id.backImageYogaClub);
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("IMAGE",R.drawable.y2);
        ...
        image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),ClubsImageViewActivity.class);
                intent.putExtra("IMAGE",R.drawable.y4);
                startActivity(intent);
            }
        });
        ...
        image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),ClubsImageViewActivity.class);
                intent.putExtra("IMAGE",R.drawable.y6);
                startActivity(intent);
            }
        });
    ...
    public void openWhatsApp(View view){
        try {
            ...
            String toNumber = "919958204472"; // Replace with mobile phone number without +Sign or leading zeros, but with country code
    ...
    public void openYoutube(View view){
        Intent intent=null;
        String url = "https://youtu.be/s7xN0iw7_mY";
        try {
    ...
    public void openInsta(View view){
        Uri uri = Uri.parse("https://www.instagram.com/ravikumaryoga/?hl=en");
        ...
        try {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("https://www.instagram.com/ravikumaryoga/?hl=en")));
        }
    }
